// Problem: Upper Bound (first index where nums[i] > target)
...
class Solution {
    ...
    // Brute Force
    public int bruteUpperBound(int[] nums, int target) {
    ...
    // Better
    public int betterUpperBound(int[] nums, int target) {
    ...
    // Optimal
    public int optimalUpperBound(int[] nums, int target) {
